...
This is a script that you can run to enable setting Key Vault Secrets on Azure Application Gateway<br>
This is not supported in the Portal and requires PS or Azure CLI
